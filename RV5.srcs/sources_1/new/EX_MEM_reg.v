...
module EX_MEM_reg(
    ...
    input rstn,
    input[31:0] instr,
    input[`BIT_WIDTH] PC, alu_result, RD1, RD2, imm,
    input regwrite, MemRead, MemWrite, MemtoReg, jump, Branch,
    output[31:0] EX_MEM_instr,
    output[`BIT_WIDTH] EX_MEM_PC, EX_MEM_alu_result, EX_MEM_RD1, EX_MEM_RD2, EX_MEM_imm,
    ...
    reg[31:0] t_instr;
    reg[`BIT_WIDTH] t_PC, t_alu_result, t_RD1, t_RD2, t_imm;
